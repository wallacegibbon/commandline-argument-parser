...
gcc -I include test/a.c $TEST_BUILD_DIR/cmd_argument_parser.o -o $TEST_BUILD_DIR/a.elf
g++ -I include test/b.cpp $TEST_BUILD_DIR/cmd_argument_parser.o -o $TEST_BUILD_DIR/b.elf
